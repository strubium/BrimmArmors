package interactive.blackout.brimm.common.blocks;

import interactive.blackout.brimm.BrimmArmors;
import interactive.blackout.brimm.client.render.IModel;
...
public class WorkbenchBlock extends Block implements IModel {
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult ray) {
        if (!world.isClientSide()) {
            ...
            BrimmArmors.network.sendTo(new SetWorkbenchScreenS2C(craftType), sv);
        }
